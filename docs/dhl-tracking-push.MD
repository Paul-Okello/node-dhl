...
info:
  ...
  description: |-
    ...
    ### Note ###
    Date and Time always conform to the ISO 8601 format e.g.: 2017-06-21T14:07:17+2:00, 2017-06-21T14:07:00Z (zoned date time) or 2017-06-21T14:07:17 (date time) or 2017-06-21 (date).
    If no time zone information is provided then time zone should be interpreted as in the place of the respective shipment event.
      ...
      requestBody:
        ...
        content:
          application/json:
            ...
            examples:
              subscription_by_trackingID_without_challenge:
                $ref: '#/components/examples/byTrackingIDWithoutChallengeDetails'
              subscription_by_trackingID_with_challenge:
                $ref: '#/components/examples/byTrackingIDWithChallengeDetails'
              subscription_by_accountID:
                $ref: '#/components/examples/byAccountID'
              subscription_with_apiKeyAuthentication:
                $ref: '#/components/examples/withApiKeyAuthentication'
              subscription_with_basicAuthentication:
                $ref: '#/components/examples/withBasicAuthentication'
              subscription_with_oauthAuthentication:
                $ref: '#/components/examples/withOAuthAuthentication'
              subscription_with_oauthBasicAuthentication:
                $ref: '#/components/examples/withOAuthBasicAuthentication'
              subscription_with_jwtAuthentication:
                $ref: '#/components/examples/withJWTAuthentication'
              subscription_with_googleApisAuthentication:
                $ref: '#/components/examples/withGApisAuthentication'
        required: true
      security:
        - DHL-API-Key: []
      responses:
...
components:
  schemas:
    ...
    SubscriptionAdmin:
      type: object
      oneOf:
        - $ref: '#/components/schemas/SubscriptionAccountAdmin'
        - $ref: '#/components/schemas/SubscriptionShipmentAdmin'
      discriminator:
        propertyName: type
        mapping:
          Account: '#/components/schemas/SubscriptionAccountAdmin'
          Shipment: '#/components/schemas/SubscriptionShipmentAdmin'
      required:
        - type
    SubscriptionRequest:
      type: object
    ...
    SubscriptionBodyAdmin:
      ...
      properties:
        ...
        secret:
          ...
          format: password
        email:
          description: The email address of the authorized person
          type: string
          format: email
        events:
          description: To which event types the notification will be sent
    ...
    SubscriptionAccountAdmin:
      ...
      allOf:
        - $ref: '#/components/schemas/SubscriptionRequestState'
        - $ref: '#/components/schemas/SubscriptionBodyAdmin'
        - $ref: '#/components/schemas/SubscriptionAccountId'
      required:
        - type
    SubscriptionShipmentAdmin:
      type: object
      allOf:
        - $ref: '#/components/schemas/SubscriptionRequestState'
        - $ref: '#/components/schemas/SubscriptionBodyAdmin'
    ...
    SubscriptionHook:
      ...
      properties:
        ...
        headers:
          description: Additional HTTP headers included with webhook push requests.
          type: array
          maxItems: 20
          items:
    ...
    UnknownEntity:
      ...
      required:
        - '@type'
    Organization:
      description: A sensitive common organization or company
      type: object
      properties:
        '@type':
          type: string
      ...
      required:
        - '@type'
    Company:
      description: A public business organization
      type: object
      properties:
        '@type':
          type: string
    ...
    TrackingShipmentDetails:
      ...
      properties:
        ...
        shipmentActivationDate:
          description: Shipment Activation date
          type: string
          format: iso8601-date-time
        dgf:routes:
        ...
        - properties:
            pieceIds:
              ...
              items:
                $ref: '#/components/schemas/PieceId'
    Location:
      description: location co-ordinates of shipment
      type: object
      properties:
        lat:
    ...
    Humidity:
      ...
      properties:
        ...
        unit:
          ...
          example: percentage
        deviceId:
          description: Sensor device id measured the humidity
          type: string
    Pressure:
      ...
      properties:
        ...
        unit:
          ...
          example: pascal
        deviceId:
          description: Sensor device id measured the pressure
          type: string
    Temperature:
      ...
      properties:
        ...
        unit:
          ...
          example: celsius
        deviceId:
          description: Sensor device id measured the temperature
          type: string
    Tilt:
      description: Tilt measurement
      type: object
      properties:
        value:
        ...
        unit:
          ...
          example: degree
        deviceId:
          description: Sensor device id measured the tilt
          type: string
    Measurement:
      description: Telemetry measurement details about shipment
      properties:
        '@policy':
          $ref: '#/components/schemas/SecretPolicy'
        timestamp:
          ...
          type: string
          format: iso8601-date-time
          x-field-extra-annotation: '@com.dhl.utapi.common.datetime.validation.LocalDateTimeConstraint'
        location:
    ...
    ApiAuthentication:
      description: The request for authentication
      type: object
      oneOf:
        ...
        - $ref: '#/components/schemas/GApisAuthentication'
        - $ref: '#/components/schemas/eBayAuthentication'
      discriminator:
        propertyName: type
        mapping:
          ApiKeyAuthentication: '#/components/schemas/ApiKeyAuthentication'
          BasicAuthentication: '#/components/schemas/BasicAuthentication'
          JWTAuthentication: '#/components/schemas/JWTAuthentication'
          OAuthAuthentication: '#/components/schemas/OAuthAuthentication'
          GApisAuthentication: '#/components/schemas/GApisAuthentication'
          eBayAuthentication: '#/components/schemas/eBayAuthentication'
    ApiKeyAuthentication:
      description: API Key HTTP header authentication
      type: object
      properties:
        type:
          description: Type of authentication
          type: string
          default: ApiKeyAuthentication
        header:
          description: The name of the HTTP header to be used for authentication
          type: string
          format: password
          pattern: '^[a-zA-Z0-9\-]+$'
        token:
          description: The secret token to be used for authentication
          type: string
          format: password
      required:
        - type
    ...
    BasicAuthentication:
      ...
      properties:
        ...
        client_id:
          description: Client ID (username) of the application
          type: string
          format: password
        client_secret:
    ...
    JWTAuthentication:
      ...
      properties:
        ...
        header:
          $ref: "#/components/schemas/JWTAuthenticationHeader"
        claim:
          $ref: "#/components/schemas/JWTAuthenticationClaim"
      required:
        - type
        - claim
    OAuthAuthentication:
      ...
      properties:
        type:
          description: Type of authentication
          type: string
          default: OAuthAuthentication
        uri:
          $ref: '#/components/schemas/URI'
        header:
          $ref: "#/components/schemas/OAuthAuthenticationHeader"
        claim:
          $ref: "#/components/schemas/OAuthAuthenticationClaim"
      required:
        - type
        - uri
        - claim
    GApisAuthentication:
      description: Google Apis OAuth authentication
      type: object
      properties:
        type:
          description: Type of authentication
          type: string
          default: GApisAuthentication
        claim:
          $ref: "#/components/schemas/GApisAuthenticationClaim"
      required:
        - type
        - claim
    eBayAuthentication:
      description: eBay OAuth authentication
      type: object
      properties:
        type:
          description: Type of authentication
          type: string
          default: eBayAuthentication
        claim:
          $ref: "#/components/schemas/eBayAuthenticationClaim"
      required:
        - type
        - claim
    OAuthAuthenticationClaim:
      type: object
      properties:
        client_id:
        ...
        client_secret:
          ...
          format: password
        grant_type:
          description: The type of grant to be used
          type: string
        custom:
          description: List of custom claim identifies of the application
          type: array
          items:
            $ref: "#/components/schemas/NameValuePair"
      required:
        - grant_type
    OAuthAuthenticationHeader:
      type: object
      properties:
        client_id:
          description: Client ID (username) of the application for Basic authentication
          type: string
          format: password
        client_secret:
          description: Client secret (password) of the application for Basic authentication
          type: string
          format: password
        custom:
      ...
      required:
        - grant_type
    GApisAuthenticationClaim:
      type: object
      properties:
        iss:
          description: Google SA Client email as issuer claim identifies the principal that issued the JWT.
          type: string
          format: email
        scope:
          description: The scope of the Google Apis access request
          type: string
      required:
        - iss
        - scope
    eBayAuthenticationClaim:
      type: object
      properties:
        keyset:
          description: eBay environment keyset
          type: string
          enum:
            - production
            - sandbox
    ...
    JWTAuthenticationHeader:
      ...
      properties:
        alg:
          $ref: "#/components/schemas/AuthenticationSignatureAlgorithm"
        typ:
    ...
    JWTAuthenticationClaim:
      ...
      properties:
        ...
        aud:
          ...
          type: string
        private:
          description: List of private claim identifies the claim of the JWT
          type: array
          items:
            $ref: "#/components/schemas/NameValuePair"
      required:
    ...
    AuthenticationSignatureAlgorithm:
      description: The signature algorithm used to sign the JWT
      type: string
      default: RS256
      enum:
        - none
  ...
  examples:
    byAccountID:
      ...
      value:
        ...
        events:
          - Transit
        accountID: '123456'
    byTrackingIDWithChallengeDetails:
      summary: 'By Tracking ID with Challenge details'
      value:
        hook:
          uri: https://webhook123.mydomain.com/track/push
        format: Default
        ...
        shipmentIDsWithChallengeDetails:
          ...
          - shipmentID: '987654321'
            postalCode: '12346'
    byTrackingIDWithoutChallengeDetails:
      summary: 'By Tracking ID without Challenge details'
      value:
        hook:
          uri: https://webhook123.mydomain.com/track/push
        format: Default
    ...
    withApiKeyAuthentication:
      summary: 'With API Key Authentication'
      value:
        hook:
          uri: https://webhook123.mydomain.com/track/push
          authentication:
      ...
      value:
        hook:
          ...
          authentication:
            ...
            client_id: yG5cTvid
            client_secret: J0mVzAzkdzZl6tWGJv
        format: Default
        type: Account
        service: ecommerce-europe
        events: [
    ...
    withOAuthAuthentication:
      summary: 'With OAuth Authentication'
      value:
        hook:
          uri: https://webhook123.mydomain.com/track/push
          authentication:
            type: OAuthAuthentication
            uri: https://webhook.test.api/token/
            claim:
              client_id: yG5cTvid
              client_secret: J0mVzAzkdzZl6tWGJv
        ...
        accountID: '123456'
    withOAuthBasicAuthentication:
      summary: 'With OAuth-Basic Authentication'
      value:
        hook:
          uri: https://webhook123.mydomain.com/track/push
          authentication:
    ...
    withJWTAuthentication:
      summary: 'With JWT Authentication'
      value:
        hook:
          uri: https://webhook123.mydomain.com/track/push
          authentication:
            ...
            claim:
              ...
              private:
                - name: scope
                  value: https://www.googleapis.com/auth/some.scope
        format: Default
        type: Account
        service: ecommerce-europe
        events: [
        ...
        accountID: '123456'
    withGApisAuthentication:
      summary: 'With Google APIs OAuth Authentication'
      value:
        hook:
          uri: https://webhook123.mydomain.com/track/push
          authentication:
            type: GApisAuthentication
            claim:
              iss: test-account@project-id.iam.gserviceaccount.com
  ...
  headers:
    correlation-id:
      description: correlation ID for tracking transaction within UTAPI
      schema:
        type: string
  parameters:
    subscriptionId:
